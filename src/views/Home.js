...
function SubscriptionModal(props) {
	...
	const subscribeNow = async () => {
		...
		try {
			const subscriptionResult = await axios.post('http://localhost:3001/api/subscribe', { ...state });
							...
							<Col lg={6} sm={6} xs={12}>
								<div className={classes.itemSubheading}>
									...
									<p className={classes.itemSubheadingSupportText}>
										...
										building. Instead of managing multiple email threads or using software designed for employees, utilize a tool that allows you to easily connect with your team members in one place. Help your team create and execute actions all in a single location, with Luci
										Tech.
									</p>
								</div>
							</Col>
